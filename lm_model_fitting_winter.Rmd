...
#### First linear regression model for D2Obs
...
#### Second  linear regression model for  D2Obs
...
#### Third linear regression model for  D2Obs

We try in this step to see whether we can improve our first model. Based on the t value and Pr value  for the variables obtained in our first model, we include the variables which have Pr value around 0.1.  Even though T2 has a Pr greater than 0.5 we include T2 in the second model also as we believe that T2 and D2 are related. This results in a new formula for the linear regression as 
...
### The selected linear model for D2Obs
...
# Graphs  Residuals vs Fitted values, Normal QQ-plot and Residuals vs Leverage.
